...
class WaitUtil {
    static async waitUntilClickable(element, timeout = 5000, timeoutMsg = 'Element was not clickable in time') {
     ...
     */
    static async waitUntilCondition(conditionFn, timeout = 5000, timeoutMsg = 'Condition was not met in time') {
